...
<%@page import="gamestore.mysql.dao.ConsoleDao"%>
<%@page import="gamestore.mysql.dao.GameDao"%>
<%@page import="gamestore.mysql.dao.TabletDao"%>
<%@page import="java.util.Calendar"%>
<%@page import="java.util.Date"%>
<%@page import="java.util.List"%>
<%@page import="gamestore.mysql.beans.ProductItem"%>
<%@page import="gamestore.mysql.beans.Console"%>
<%@page import="gamestore.mysql.beans.Accessory"%>
<%@page import="gamestore.mysql.beans.Game"%>
<%@page import="gamestore.mysql.beans.Tablet"%>
<%@page import="gamestore.mysql.beans.Review"%>
