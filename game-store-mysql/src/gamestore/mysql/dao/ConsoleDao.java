 ...
 */
package gamestore.mysql.dao;

import java.util.ArrayList;
import java.util.Date;
import java.util.List;

import gamestore.mysql.beans.Accessory;
import gamestore.mysql.beans.Console;
import gamestore.mysql.beans.Review;
import gamestore.mysql.common.Constants;
import gamestore.mysql.common.SerializeHelper;
